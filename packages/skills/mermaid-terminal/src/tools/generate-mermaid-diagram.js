...
function generateFlowchart(objective, _context) {
    ...
    steps.forEach((step, index) => {
        ...
        const cleanedStep = step.trim().substring(0, 40);
...
function generateSequenceDiagram(objective, context) {
...
function generateStateDiagram(objective, _context) {
...
function generateMermaidDiagram(objective, diagramType, context) {
    switch (diagramType) {
...
function createTextPreview(mermaidCode) {
...
export const GenerateMermaidDiagramTool = {
    ...
    description: "Generate terminal-friendly Mermaid diagrams and flowcharts based on an objective description.",
    inputSchema: {
        type: "object",
        properties: {
            objective: {
                type: "string",
                description: "Description of what the diagram should represent (e.g., 'User login flow, Data validation, API call')",
            },
            context: {
                type: "string",
                description: "Optional additional context or details about the diagram (e.g., 'Actors: Client, Server, Database')",
            },
            type: {
                type: "string",
                enum: ["flowchart", "sequenceDiagram", "stateDiagram", "auto"],
                description: "Type of diagram to generate. 'auto' detects the best type from objective.",
            },
        },
        required: ["objective"],
    },
    async handler(input) {
        try {
            ...
            const diagramType = specifiedType === "auto" ? detectDiagramType(objective) : specifiedType;
...
//# sourceMappingURL=generate-mermaid-diagram.js.map