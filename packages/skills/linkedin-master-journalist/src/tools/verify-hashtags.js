...
export const VerifyHashtagsTool = {
    ...
    async handler(input) {
        ...
        const verification = {
            ...
            valid: 0,
            unknownCount: 0,
            byTier: { high: 0, medium: 0, niche: 0 },
            recommendations: [],
            strategyMatch: false,
            details: [],
        };
        ...
        if (verification.unknownCount > 0) {
            verification.recommendations.push(`${verification.unknownCount} hashtags not in our database. Research recent LinkedIn trends for these.`);
        }
        return {
            success: true,
            verification,
...
//# sourceMappingURL=verify-hashtags.js.map