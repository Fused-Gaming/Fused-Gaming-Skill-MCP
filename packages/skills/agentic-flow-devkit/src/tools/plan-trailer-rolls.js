const buildABRollPlan = (campaign, tone, beats) => {
    const aRoll = [
...
export const PlanTrailerRollsTool = {
    name: "plan-trailer-rolls",
    description: "Generate A-roll and B-roll sourcing plans for trailer promo elevator pitches.",
    inputSchema: {
        type: "object",
        properties: {
            campaign: {
    ...
    async handler(input) {
        const { campaign, tone, beats } = input;
        return {
            success: true,
...
//# sourceMappingURL=plan-trailer-rolls.js.map